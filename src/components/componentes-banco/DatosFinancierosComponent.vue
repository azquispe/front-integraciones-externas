    ...
    <v-card elevation="4" class="ma-5">
      ...
      <div class="pa-5">
        ...
        >
          ...
          <v-card outlined class="ma-2  pa-2"  max-width="300">
            <span class="title rosa_FFB695--text">LÍNEA DE CRÉDITO</span>
          ...
          <v-card outlined class="ma-2  pa-2"  max-width="300">
            <span class="title rosa_FFB695--text">DEUDORES</span>
          
              <div v-for="obj in objDatosFinancieros.deudores" :key="obj" class="pa-0">
                <div >
